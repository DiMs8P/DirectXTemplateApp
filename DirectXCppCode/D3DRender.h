...
//		ID3D11Texture2D* pBackBuffer = NULL;
	...
	RenderingUnit CreateTriangleColorUnit(std::vector<std::array<std::array<int, 3>,2>>& Triangles, std::vector<std::array<double, 3>>& vertexes, std::vector<std::array<double, 3>>& normals) //� ���� ������ -- �����������, ������ -- rgb ����
	{
		RenderingUnit unit;
